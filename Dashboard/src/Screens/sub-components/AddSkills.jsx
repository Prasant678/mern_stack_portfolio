...
import { addNewSkill, clearAllSkillErrors, getAllSkills, resetSkillSlice } from "@/store/Slice/skillSlice";
      ...
      <div className="flex justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14">
        ...
        >
          <div className="space-y-12">
              <h2 className="font-semibold leading-7 text-black text-3xl text-center pt-6">
                ADD A NEW SKILL
              </h2>
              <div className="mt-10 flex flex-col gap-5">
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      <Input
                        type="text"
                        className="block flex-1 border-black bg-transparent py-2 px-3 text-black placeholder:text-black focus:ring-0 sm:text-sm sm:leading-6"
                ...
                <div className="w-full col-span-full">
                  ...
                  <div className="mt-2 flex justify-center rounded-lg border border-black px-6 py-10">
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            {!loading ? (
              ...
              >
               ...
               <LoadingSpinner content={"Adding New Skill"} />
            )}
          </div>
        </form>
      </div>
